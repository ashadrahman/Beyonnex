...
def click_buy_moisturizers_button(browser):
    ...
    '''
    browser.find_element(by = By.XPATH, value = ("//button[text()='Buy moisturizers']")).click()
...
def parse_aloe(browser):
    ...
    '''
    list_elements = browser.find_elements(by = By.XPATH, value = ("//*[contains(text(),'Aloe')]\
        /following-sibling::p"))
...
def parse_almond(browser):
    '''
        ...
        and returns the cost of all items in a list.
    '''
    list_elements = browser.find_elements(by = By.XPATH, value = ("//*[contains(text(),'Almond')]\
        /following-sibling::p"))
    return list_finder(list_elements)
...
def add_aloe(browser):
    ...
    browser.find_element(by = By.XPATH, value = ("//*[contains(text(),'Aloe')]/\
...
def add_almond(browser):
    ...
    minimum_price = str(min(price_list))
    browser.find_element(by = By.XPATH, value = ("//*[contains(text(),'Almond')]/\
        following-sibling::p[contains(text(),%s)]/\
            following-sibling::button[text() = 'Add']"%minimum_price)).click()
